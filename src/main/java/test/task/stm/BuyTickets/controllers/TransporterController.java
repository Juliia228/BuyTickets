...
public class TransporterController {
    ...
    @GetMapping("/getById")
    public ResponseEntity<Transporter> getTransporter(@RequestParam String name) {
    ...
    @PostMapping("/add")
    public ResponseEntity<Transporter> newTransporter(@RequestBody Transporter new_transporter) {
        return ResponseEntity.ok(transporterService.add(new_transporter));
    }

    @PutMapping("/edit")
    public ResponseEntity<Transporter> updateTransporter(@RequestBody Transporter new_transporter) {
