...
public class UserRequest {
    ...
    @Schema(description = "Пароль. Должен содержать не менее 8 символов, хотя бы 1 цифру, 1 заглавную букву, 1 строчную букву и 1 специальный символ", example = "Example1!")
